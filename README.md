...
🌐 Front-End: Angular, TypeScript/JavaScript, RxJS, NX, NGXS, Less/Sass, PWAs, Electron.js
💻 Back-End: C#, ASP.NET Core
🎨 UI Styling: Ant-Design, Angular Material Design, PrimeNG, ngZorro, BEM, Tailwind CSS, Bootstrap
🛠️ Tools: Figma, Zeplin, Miro
🚀 Deployments: GitHub, GitLab, Bitbucket, Vercel, Netlify, Surge
🔍 Currently Exploring: NGRX, AnalogJS, Cypress, Playwright, Astro
...
🌐I'm open to remote opportunities, both contract and full-time positions. If you have anything interesting for me, let's have a 15-min free call: 
https://calendly.com/solat-ali/1-1-coffee-chat

Looking forward to connecting and discussing your needs or questions!
